    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('normal', 'Normal'), ('pivot', 'Pivot')], default='normal', help_text='normal = standard sheet, pivot = pivot table sheet', max_length=20)),
                ('frozen_row_count', models.PositiveSmallIntegerField(default=0, help_text='Number of rows to freeze (0 = none, 1 = freeze first row, etc.)')),
                ('frozen_column_count', models.PositiveSmallIntegerField(default=0, help_text='Number of columns to freeze (0 = none)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('font_family', models.CharField(blank=True, help_text='Font family e.g. Arial, Helvetica', max_length=100, null=True)),
                ('font_size', models.PositiveSmallIntegerField(blank=True, help_text='Font size in pixels', null=True)),
                ('number_format', models.JSONField(blank=True, help_text='Display format for numeric cells (type, currency_code, decimal_places)', null=True)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['sheet'], name='spreadsheet_sheet_i_c79485_idx'),
        ),
        migrations.AddConstraint(
            model_name='spreadsheetcellformat',
            constraint=models.UniqueConstraint(fields=('sheet', 'row_index', 'column_index'), name='unique_sheet_cell_format_position'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['source_sheet'], name='pivotconfig_source_sheet_idx'),
        ),
        migrations.AddIndex(
