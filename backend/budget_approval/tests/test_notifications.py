...
class BudgetNotificationTests(TransactionTestCase):
    ...
    def setUp(self):
        self.org = Organization.objects.create(name="BudgetNotifOrg", slug="budgetnotiforg")
        self.requester = _make_user("req@example.com", "requester", self.org)
        self.approver = _make_user("appr@example.com", "approver", self.org)
        self.project = Project.objects.create(
            name="Budget Project",
            organization=self.org,
        )
        self.ad_channel = AdChannel.objects.create(name="Meta", project=self.project)
        self.pool = BudgetPool.objects.create(
