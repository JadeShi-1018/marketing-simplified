    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='notion_connection', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'notion_connections',
                'indexes': [models.Index(fields=['is_active'], name='notion_conn_is_acti_df463d_idx'), models.Index(fields=['workspace_id'], name='notion_conn_workspa_ecab92_idx')],
            },
        ),
        migrations.CreateModel(
            name='MediaFile',
