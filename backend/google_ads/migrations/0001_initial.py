    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, help_text='Immutable. The name of the ad. This is only used to be able to identify the ad. Must be unique.', max_length=255, unique=True)),
                ...
                ('status', models.CharField(choices=[('DRAFT', 'Draft'), ('PENDING_REVIEW', 'Pending Review'), ('APPROVED', 'Approved'), ('REJECTED', 'Rejected'), ('PUBLISHED', 'Published'), ('PAUSED', 'Paused')], default='DRAFT', help_text='Ad status for workflow management', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_hash', models.CharField(blank=True, default='', help_text='Image hash', max_length=255)),
                ('url', models.CharField(blank=True, default='', help_text='Image URL', max_length=512)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(blank=True, default='YouTube Video', help_text='Video title', max_length=255)),
                ('video_id', models.CharField(blank=True, default='', help_text='YouTube video ID', max_length=64)),
                ('image_url', models.CharField(blank=True, default='', help_text='Thumbnail URL (placeholder)', max_length=512)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('companion_banners', models.ManyToManyField(blank=True, help_text='Image asset used for the companion banner (only one value supported)', related_name='video_responsive_ad_companion_banners', to='google_ads.googleadsphotodata')),
                ...
                ('videos', models.ManyToManyField(blank=True, help_text='YouTube video asset used for the ad (only one value supported)', related_name='video_responsive_ad_videos', to='google_ads.googleadsvideodata')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_asset', models.ForeignKey(blank=True, help_text='The Asset resource name of this video (GoogleAdsVideoData)', null=True, on_delete=django.db.models.deletion.SET_NULL, to='google_ads.googleadsvideodata')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo_images', models.ManyToManyField(blank=True, help_text='Logo images to be used in the ad', related_name='responsive_display_ad_logo_images', to='google_ads.googleadsphotodata')),
                ...
                ('marketing_images', models.ManyToManyField(blank=True, help_text='Marketing images to be used in the ad', related_name='responsive_display_ad_marketing_images', to='google_ads.googleadsphotodata')),
                ('square_logo_images', models.ManyToManyField(blank=True, help_text='Square logo images to be used in the ad', related_name='responsive_display_ad_square_logo_images', to='google_ads.googleadsphotodata')),
                ('square_marketing_images', models.ManyToManyField(blank=True, help_text='Square marketing images to be used in the ad', related_name='responsive_display_ad_square_marketing_images', to='google_ads.googleadsphotodata')),
                ('youtube_videos', models.ManyToManyField(blank=True, help_text='Optional YouTube videos for the ad', related_name='responsive_display_ad_youtube_videos', to='google_ads.googleadsvideodata')),
            ],
        ),
        migrations.CreateModel(
            name='ImageAdInfo',
        ...
        migrations.AddField(
            model_name='ad',
            name='media_campaign',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='google_ads', to='campaign.campaign'),
        ),
        migrations.AddField(
            model_name='ad',
