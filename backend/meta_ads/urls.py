...
urlpatterns = [
    ...
    path(
        "campaigns/<str:campaign_id>/performance_timeseries/",
    ...
    path(
        "adsets/<str:adset_id>/performance_timeseries/",
    ...
    path(
        "creatives/<str:creative_id>/video_source/",
        MetaCreativeVideoSourceView.as_view(),
        name="meta-creative-video-source",
    ),
    path(
        "creatives/<str:creative_id>/performance_timeseries/",
