...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('type', models.CharField(choices=[('text', 'Text'), ('shape', 'Shape'), ('sticky_note', 'Sticky Note'), ('frame', 'Frame'), ('line', 'Line'), ('connector', 'Connector'), ('freehand', 'Freehand'), ('emoji', 'Emoji')], help_text='Type of the board item', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('board', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='accesses', to='miro.board')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='board_accesses', to='core.project')),
            ...
            options={
                'indexes': [models.Index(fields=['user', 'project'], name='miro_boarda_user_id_e19366_idx'), models.Index(fields=['project', 'last_accessed_at'], name='miro_boarda_project_8f57a4_idx')],
