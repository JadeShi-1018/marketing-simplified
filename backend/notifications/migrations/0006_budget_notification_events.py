...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("notifications", "0005_rename_notificatio_recipie_0f8a2d_idx_notificatio_recipie_a972ce_idx_and_more"),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("budget_review_needed", "Budget needs review"),
                    ("budget_approval_result", "Budget approval result"),
                    ("budget_pool_low", "Budget pool insufficient"),
