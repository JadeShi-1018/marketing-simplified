    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, help_text="Custom name for this transition (e.g., 'Start Work', 'Merge'). If not provided, defaults to 'Source → Target'", max_length=255, null=True)),
