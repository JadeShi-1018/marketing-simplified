"""Data migration: re-encrypt SlackWorkspaceConnection.encrypted_access_token."""
...
def forwards(apps, schema_editor):
    ...
    SlackWorkspaceConnection = apps.get_model("slack_integration", "SlackWorkspaceConnection")

    updated = 0
    for conn in SlackWorkspaceConnection.objects.all():
    ...
    logger.info("slack_integration backfill: %d rows re-encrypted.", updated)
