"""Data migration: re-encrypt GoogleDocsConnection tokens."""
...
def forwards(apps, schema_editor):
    ...
    GoogleDocsConnection = apps.get_model("google_docs_integration", "GoogleDocsConnection")

    updated = 0
    for conn in GoogleDocsConnection.objects.all():
        changed = False
    ...
    logger.info("google_docs_integration backfill: %d rows re-encrypted.", updated)
