    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_campaign_id', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('media_campaign', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='mailchimp_drafts', to='campaign.campaign')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mailchimp_templates', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('links', models.JSONField(blank=True, null=True)),
                ('template', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='default_content', to='mailchimp.template')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('winning_combination_id', models.CharField(blank=True, max_length=100, null=True)),
                ('winning_campaign_id', models.CharField(blank=True, max_length=100, null=True)),
                ('winner_criteria', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('campaign', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='variate_settings', to='mailchimp.campaign')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campaign', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='tracking', to='mailchimp.campaign')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campaign', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='social_card', to='mailchimp.campaign')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drag_and_drop', models.BooleanField(default=False)),
                ('campaign', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='settings', to='mailchimp.campaign')),
                ('template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='mailchimp.template')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campaign', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='rss_opts', to='mailchimp.campaign')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campaign', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='resend_shortcut_usage', to='mailchimp.campaign')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campaign', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='resend_shortcut_eligibility', to='mailchimp.campaign')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campaign', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='report_summary', to='mailchimp.campaign')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campaign', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='recipients', to='mailchimp.campaign')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campaign', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='delivery_status', to='mailchimp.campaign')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_block_id', models.CharField(blank=True, max_length=255, null=True)),
                ('resolved_at', models.DateTimeField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='campaign_comments', to=settings.AUTH_USER_MODEL)),
                ('campaign', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='mailchimp.campaign')),
                ('resolved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='resolved_campaign_comments', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_name_a', models.CharField(blank=True, max_length=255, null=True)),
                ('from_name_b', models.CharField(blank=True, max_length=255, null=True)),
                ('reply_email_a', models.EmailField(blank=True, max_length=254, null=True)),
                ('reply_email_b', models.EmailField(blank=True, max_length=254, null=True)),
                ...
                ('campaign', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='ab_split_opts', to='mailchimp.campaign')),
            ],
        ),
    ]
