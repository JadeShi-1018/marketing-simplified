...
export default function UpcomingMeetingsPanel({
  ...
  return (
    <aside
      className={`fixed bottom-0 right-0 top-12 z-40 w-[min(360px,calc(100vw-3.5rem))] shrink-0 overflow-hidden border-l border-gray-200 bg-white shadow-2xl transition-transform duration-300 sm:static sm:top-auto sm:z-auto sm:h-full sm:translate-x-0 sm:shadow-none sm:transition-all ${
