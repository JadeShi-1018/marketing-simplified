...
const BACKLOG_GROUP_TASKS_CLASS = 'mt-2 max-h-48 overflow-y-auto overscroll-contain';
const COMPACT_SCROLL_CLASS = 'max-h-96 overflow-y-auto overscroll-contain';
const PAIR_SCROLL_CLASS = 'max-h-[37.5rem] overflow-y-auto overscroll-contain';
