    ...
    <DashboardLayout alerts={[]} upcomingMeetings={[]}>
      <div className="mx-auto w-full max-w-7xl px-3 py-5 sm:px-6 sm:py-8">
        ...
        <CampaignListTable
          ...
          onRowClick={(c) => router.push(`/projects/${projectId}/campaigns/${c.slug}`)}
        />
